...
`streamlit_app.py`; evidence ships in-repo. 3,798 tests green (rev 17) across
...
current result is **3,798 passed / 6 skipped**.
...
3. `python -m pytest -q` — expect fully green (3,798 passed as of rev 17, plus
